...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        {// string sort nome é a ordenação que quer
            var resultado = _context.Pedidos.AsNoTracking()
                                      .AsQueryable();
            //asNotracking as entidades não são rastreada pelo contexto,assim o ef não realiza processo add
            //ele so pode ser usado quando vc ta listando informação
            //.AsQueryable tranforma o Ienurebla em IQueryable
            ...
            // o 3 é quantas paginas  e o RouteValue vc vai usar na view
